...
export const Heading = () => {
  return (
    <Box
      sx={{
        marginTop: `${CSS_VALUES.sectionSideMargin}px`,
    ...
    >
      ...
      <Box sx={{ marginTop: `${CSS_VALUES.marginBetweenSections}px` }}>
        <Typography
          sx={{
            fontSize: '28px',
        ...
        <Typography
          ...
          color={COLOR.base}
        >
          Мы рады сообщить вам, что состоится долгожданное событие - наша свадьба! Мы искренне хотим
          разделить наше счастье в кругу семьи и близких нам людей!
        </Typography>
        <Calendar />
      </Box>
    </Box>
